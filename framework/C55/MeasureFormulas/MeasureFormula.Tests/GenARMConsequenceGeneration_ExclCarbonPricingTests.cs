...
using baseClass = MeasureFormulas.Generated_Formula_Base_Classes.GenARMConsequenceGeneration_ExclCarbonPricingBase;
using formulaClass = CustomerFormulaCode.GenARMConsequenceGeneration_ExclCarbonPricing;
 
namespace MeasureFormula.Tests
{
    [TestFixture]
    public class GenARMConsequenceGeneration_ExclCarbonPricingTests : AssetModelTestsBase 
    {
