...
{
    [FormulaBase]
    public abstract class ManualRiskProbabilityFormulaBase : FormulaLikelihoodBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                CL.FormulaHelper.DTOs.NumericValueRangeDTO p_RiskLikelihood,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                RiskLikelihood = p_RiskLikelihood;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("RiskLikelihood")]
            [DataMember]
            public CL.FormulaHelper.DTOs.NumericValueRangeDTO RiskLikelihood  { get; private set; }
