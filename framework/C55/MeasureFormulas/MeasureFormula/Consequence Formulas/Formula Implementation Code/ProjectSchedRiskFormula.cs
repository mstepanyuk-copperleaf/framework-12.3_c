...
{
    [Formula]
    public class ProjectSchedRiskFormula : ProjectSchedRiskFormulaBase
    {
            ...
            TimeInvariantInputDTO timeInvariantData, IReadOnlyList<TimeVariantInputDTO> timeVariantData)
        {
            ...
            var projectAnnualScheduleRisk = timeInvariantData.ExpectedLikelihoodPercentage / 100 * timeInvariantData.ExpectedDays;
            var monthsDuration = System.Math.Abs(maxSpendIndex.Value - minSpendIndex.Value) + 1;
            var monthlyRisk = projectAnnualScheduleRisk / monthsDuration;
