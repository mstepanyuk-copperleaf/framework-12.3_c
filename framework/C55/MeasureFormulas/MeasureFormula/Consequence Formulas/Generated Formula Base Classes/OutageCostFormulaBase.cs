...
{
    [FormulaBase]
    public abstract class OutageCostFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_OutageCost,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                OutageCost = p_OutageCost;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("OutageCost")]
            [DataMember]
            public System.Int32 OutageCost  { get; private set; }
