...
{
    [FormulaBase]
    public abstract class ProjectCostRiskFormulaNewBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Int32 p_ExpectedCostp50,
                System.Int32 p_HighCostp90,
                CL.FormulaHelper.DTOs.DistributionByAccountTypeDTO p_InvestmentSpendByAccountType,
                System.Int32 p_LowCostp10)
            {
                ExpectedCostp50 = p_ExpectedCostp50;
                HighCostp90 = p_HighCostp90;
                InvestmentSpendByAccountType = p_InvestmentSpendByAccountType;
                LowCostp10 = p_LowCostp10;
            }
            
            [PromptInput("ExpectedCostp50")]
            [DataMember]
            public System.Int32 ExpectedCostp50  { get; private set; }
            
            [PromptInput("HighCostp90")]
            [DataMember]
            public System.Int32 HighCostp90  { get; private set; }
            ...
            [PromptInput("LowCostp10")]
            [DataMember]
            public System.Int32 LowCostp10  { get; private set; }
        }
