...
{
    [FormulaBase]
    public abstract class ManualCapitalFinancialBenefitFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_CapFinBenefAmount,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                CapFinBenefAmount = p_CapFinBenefAmount;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("CapFinBenefAmount")]
            [DataMember]
            public System.Int32 CapFinBenefAmount  { get; private set; }
