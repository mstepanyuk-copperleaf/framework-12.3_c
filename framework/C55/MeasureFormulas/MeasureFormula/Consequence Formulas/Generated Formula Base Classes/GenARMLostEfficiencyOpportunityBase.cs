...
{
    [FormulaBase]
    public abstract class GenARMLostEfficiencyOpportunityBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Double?[] p_GenARM_TurbineAgeDegradation_ConsqUnitOutput,
                System.Double?[] p_GenARM_TurbineTechImprovement_ConsqUnitOutput)
            {
                GenARM_TurbineAgeDegradation_ConsqUnitOutput = p_GenARM_TurbineAgeDegradation_ConsqUnitOutput;
                GenARM_TurbineTechImprovement_ConsqUnitOutput = p_GenARM_TurbineTechImprovement_ConsqUnitOutput;
            }
            
            [MeasureInput("GenARM", "TurbineAgeDegradation", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] GenARM_TurbineAgeDegradation_ConsqUnitOutput  { get; private set; }
            
            [MeasureInput("GenARM", "TurbineTechImprovement", MeasureOutputType.ConsqUnitOutput, false)]
            [DataMember]
            public System.Double?[] GenARM_TurbineTechImprovement_ConsqUnitOutput  { get; private set; }
        }
