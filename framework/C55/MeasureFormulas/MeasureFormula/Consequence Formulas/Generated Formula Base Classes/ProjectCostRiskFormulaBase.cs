...
{
    [FormulaBase]
    public abstract class ProjectCostRiskFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Int32 p_ExpectedCost,
