...
{
    [FormulaBase]
    public abstract class ManualOMFinancialBenefitFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_OMFinBenefLaborHr,
                System.Int32 p_OMFinBenefMaterialCost,
                System.Int32 p_OMFinBenefOtherDirectCost,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                OMFinBenefLaborHr = p_OMFinBenefLaborHr;
                OMFinBenefMaterialCost = p_OMFinBenefMaterialCost;
                OMFinBenefOtherDirectCost = p_OMFinBenefOtherDirectCost;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("OMFinBenefLaborHr")]
            [DataMember]
            public System.Int32 OMFinBenefLaborHr  { get; private set; }
            
            [PromptInput("OMFinBenefMaterialCost")]
            [DataMember]
            public System.Int32 OMFinBenefMaterialCost  { get; private set; }
            
            [PromptInput("OMFinBenefOtherDirectCost")]
            [DataMember]
            public System.Int32 OMFinBenefOtherDirectCost  { get; private set; }
