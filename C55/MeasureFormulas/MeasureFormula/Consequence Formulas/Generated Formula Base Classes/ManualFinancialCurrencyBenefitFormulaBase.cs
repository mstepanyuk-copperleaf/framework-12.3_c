...
{
    [FormulaBase]
    public abstract class ManualFinancialCurrencyBenefitFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_FinCurBenefAmount,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                FinCurBenefAmount = p_FinCurBenefAmount;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("FinCurBenefAmount")]
            [DataMember]
            public System.Int32 FinCurBenefAmount  { get; private set; }
