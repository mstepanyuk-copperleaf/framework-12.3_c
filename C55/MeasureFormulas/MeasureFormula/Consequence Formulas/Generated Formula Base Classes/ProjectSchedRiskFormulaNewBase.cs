...
{
    [FormulaBase]
    public abstract class ProjectSchedRiskFormulaNewBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Int32 p_ExpectedDaysp50,
                System.Int32 p_HighDaysp90,
                CL.FormulaHelper.DTOs.DistributionByAccountTypeDTO p_InvestmentSpendByAccountType,
                System.Int32 p_LowDaysp10)
            {
                ExpectedDaysp50 = p_ExpectedDaysp50;
                HighDaysp90 = p_HighDaysp90;
                InvestmentSpendByAccountType = p_InvestmentSpendByAccountType;
                LowDaysp10 = p_LowDaysp10;
            }
            
            [PromptInput("ExpectedDaysp50")]
            [DataMember]
            public System.Int32 ExpectedDaysp50  { get; private set; }
            
            [PromptInput("HighDaysp90")]
            [DataMember]
            public System.Int32 HighDaysp90  { get; private set; }
            ...
            [PromptInput("LowDaysp10")]
            [DataMember]
            public System.Int32 LowDaysp10  { get; private set; }
        }
