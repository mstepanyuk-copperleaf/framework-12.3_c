...
{
    [FormulaBase]
    public abstract class ProjectSchedRiskFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                System.Int32 p_ExpectedDays,
                System.Int32 p_ExpectedLikelihoodPercentage,
                CL.FormulaHelper.DTOs.DistributionByAccountTypeDTO p_InvestmentSpendByAccountType)
            {
                ExpectedDays = p_ExpectedDays;
                ExpectedLikelihoodPercentage = p_ExpectedLikelihoodPercentage;
                InvestmentSpendByAccountType = p_InvestmentSpendByAccountType;
            }
            
            [PromptInput("ExpectedDays")]
            [DataMember]
            public System.Int32 ExpectedDays  { get; private set; }
            
            [PromptInput("ExpectedLikelihoodPercentage")]
            [DataMember]
            public System.Int32 ExpectedLikelihoodPercentage  { get; private set; }
