...
{
    [FormulaBase]
    public abstract class NormalizedAgeBaselineBase : FormulaConsequenceBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            public TimeInvariantInputDTO(
                ...
                System.Int32? p_AssetUsefulLifetimeYears,
                System.Double? p_SystemCondition_32_Score_32_Best)
            {
                AssetInServiceDate = p_AssetInServiceDate;
                AssetUsefulLifetimeYears = p_AssetUsefulLifetimeYears;
            ...
            [CoreFieldInput(FormulaCoreFieldInputType.AssetUsefulLifetimeYears)]
            [DataMember]
            public System.Int32? AssetUsefulLifetimeYears  { get; private set; }
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Double p_BaseCondition,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                BaseCondition = p_BaseCondition;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("BaseCondition")]
            [DataMember]
            public System.Double BaseCondition  { get; private set; }
