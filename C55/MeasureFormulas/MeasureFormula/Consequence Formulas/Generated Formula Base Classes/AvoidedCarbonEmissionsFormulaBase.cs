...
{
    [FormulaBase]
    public abstract class AvoidedCarbonEmissionsFormulaBase : FormulaConsequenceBase
    {
        [DataContract]
        ...
        public class TimeVariantInputDTO : ITimeVariantInputDTO
        {
            public TimeVariantInputDTO(
                System.Int32 p_AvoidedCarbonEmissions,
                CL.FormulaHelper.DTOs.TimePeriodDTO p_TimePeriod)
            {
                AvoidedCarbonEmissions = p_AvoidedCarbonEmissions;
                TimePeriod = p_TimePeriod;
            }
            
            [PromptInput("AvoidedCarbonEmissions")]
            [DataMember]
            public System.Int32 AvoidedCarbonEmissions  { get; private set; }
