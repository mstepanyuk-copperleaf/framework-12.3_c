...
{
    [FormulaBase]
    public abstract class GenARMConditionalProbability_IgnoreDCRBase : FormulaLikelihoodBase
    {
        [DataContract]
        public class TimeInvariantInputDTO
        {
            ...
            [PromptInput("IgnoreDCR")]
            [DataMember]
            public System.Boolean? IgnoreDCR  { get; private set; }
        }
